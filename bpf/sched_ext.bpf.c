...
s32
BPF_STRUCT_OPS(simple_select_cpu, struct task_struct *p, s32 prev_cpu,
               u64 wake_flags)
{
  bool is_idle = false;
  s32 cpu;
...
void
BPF_STRUCT_OPS(simple_enqueue, struct task_struct *p, u64 enq_flags)
{
...
void
BPF_STRUCT_OPS(simple_running, struct task_struct *p)
{
  if (fifo_sched)
    return;
...
void
BPF_STRUCT_OPS(simple_stopping, struct task_struct *p, bool runnable)
{
  if (fifo_sched)
    return;
...
void
BPF_STRUCT_OPS(simple_enable, struct task_struct *p)
{
